...
namespace GetTogether.DAL.Migrations
{
    ...
    [Migration("20230317155815_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GetTogether.DAL.Entities.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GetTogether.DAL.Entities.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GetTogether.DAL.Entities.ChatGroup", b =>
                {
                    b.HasOne("GetTogether.DAL.Entities.UserProfile", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("GetTogether.DAL.Entities.Message", b =>
                {
                    b.HasOne("GetTogether.DAL.Entities.UserProfile", "Author")
                        .WithOne()
                    ...
                    b.HasOne("GetTogether.DAL.Entities.UserProfile", "RepliedPerson")
                        .WithOne()
            ...
            modelBuilder.Entity("GetTogether.DAL.Entities.UserProfile", b =>
                {
                    b.HasOne("GetTogether.DAL.Entities.UserAccount", "Account")
                        .WithOne("Profile")
                        .HasForeignKey("GetTogether.DAL.Entities.UserProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("object", b =>
                {
                    b.HasOne("GetTogether.DAL.Entities.UserProfile", null)
                        .WithMany()
